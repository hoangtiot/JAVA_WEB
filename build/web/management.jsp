<%-- 
    Document   : management
    Created on : Mar 12, 2021, 6:48:16 PM
    Author     : PC
--%>
                    ...
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <h5><a href="home.jsp" >Back to Home</a></h5>
                            </div>
                            
                            <div class="col-sm-6">
                                <a href="create.jsp" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add New Employee</span></a>
                            ...
                            <form action="MainController">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${sessionScope.ERROR_ID == p.productID}" >
                                            ${sessionScope.ERROR_MSG.nameError}
                                        </c:if>
                                    </td>
                                    <td>
                                        <input type="number" step="0.01" class="form-control" required name="price" value="${p.price}">
                                        <c:if test="${sessionScope.ERROR_ID == p.productID}" >
                                            ${sessionScope.ERROR_MSG.priceError}
                                        </c:if>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" required name="quantity" value="${p.quantity}">
                                        <c:if test="${sessionScope.ERROR_ID == p.productID}" >
                                            ${sessionScope.ERROR_MSG.quantityError}
                                        </c:if>
                                    </td>
                                    <td>
                                        <input type="textarea" class="form-control" required name="description" value="${p.description}">
                                        <c:if test="${sessionScope.ERROR_ID == p.productID}" >
                                            ${sessionScope.ERROR_MSG.descriptionError}
                                        </c:if>
                                    </td>
                                    <td><select name="categoryID" >
                                            <c:forEach items="${sessionScope.LIST_CATE}" var="c">
                                                <option value="${c.categoryID}" <c:if test="${c.categoryID == p.categoryID}">selected</c:if>>${c.name}</option>
                                            </c:forEach>
                                        </select></td>
                                    <td>
                                        <img src="${p.img}" width="190">
                                        <input type="file" class="form-control" name="img" required accept=".jpg, .jpeg, .jpe .jif, .jfif, .jfi, .png, .gif, .webp, .tiff, .psd, .raw" width="10">
                                    </td>
                                    <td>
                                        ...
                                        <c:url var="update" value="MainController">
                                            ...
                                            <c:param name="quantity" value="${p.quantity}"></c:param>
                                            <c:param name="description" value="${p.description}"></c:param>
                                            <c:param name="categoryID" value="${p.categoryID}"></c:param>
                                            <c:param name="img" value="${p.img}"></c:param>
                                        </c:url>
                                        </h1>-->
                                        ...
                                        <a href="${delete}"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </form>
                        </c:forEach>				 
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="categoryID" >
                                    <c:forEach items="${requestScope.LIST_CATE}" var="c">
        ...
        <!--        <div id="editEmployeeModal" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form>
                                <div class="modal-header">						
                                    <h4 class="modal-title">Edit Phones</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
