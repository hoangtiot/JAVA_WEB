<%-- 
    Document   : login
    Created on : Mar 12, 2021, 7:03:20 PM
    Author     : PC
--%>
    ...
    <body>
        <div class="login-form">
            <form action="MainController" method="post">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary login-btn btn-block" name="action" value="Login">Sign in</button>
                </div>
                <div class="clearfix">
                ...
                <div class="text-center social-btn">
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/PhoneStore/LoginGoogleController&response_type=code&client_id=388122359145-02r2qsa3ilbff8pp0qfhnbdbrr37perp.apps.googleusercontent.com&approval_prompt=force" class="btn btn-danger"><i class="fa fa-google"></i>&nbsp; Google</a>
                </div>
            </form>
